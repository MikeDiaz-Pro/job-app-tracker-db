...
import { Edit, EditPencil, Trash } from "iconoir-react";
import { useState } from "react";
import { useDispatch } from "react-redux";
import { deleteApplication, fetchApplications } from "../store/applicationsActions";
...
const ApplicationRow = ({ data }) => {
  ...
  const handleDelete = () => {
    if (window.confirm("Are you sure you want to delete this application?")) {
      dispatch(deleteApplication(data.id));
